...
////////////////////////////////////////////////////////////// // fasc
#ifdef FASC_BUILD
    void setFascSchedule(EVMSchedule _fascSchedule) const { fascSchedule = _fascSchedule; }

    EVMSchedule& getFascSchedule() const { return fascSchedule; }
...
#ifdef FASC_BUILD
    mutable EVMSchedule fascSchedule; // Fasc
#endif    
